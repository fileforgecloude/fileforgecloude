...
export const DashboardHeader = ({ onUploadClick, onCreateFolderClick, searchQuery, onSearchChange }: DashboardHeaderProps) => {
  return (
    <div className='flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8'>
      <div className='flex items-center gap-4 flex-1 max-w-2xl'>
        <h1 className='text-2xl font-semibold text-slate-800 dark:text-slate-100 px-2 hidden sm:block'>My Drive</h1>
